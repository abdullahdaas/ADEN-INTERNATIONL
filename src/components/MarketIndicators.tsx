    ...
    <div id="market-indicators-panel" className="rounded-2xl border border-white/5 bg-slate-900/10 backdrop-blur-md p-6">
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4 mb-8">
        ...
        <div className="p-4 rounded-xl border border-white/5 bg-slate-950/30">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500 font-sans">إعلان نشط</span>
          </div>
        ...
        <div className="p-4 rounded-xl border border-white/5 bg-slate-950/30">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500 font-sans">صفقة موثقة</span>
          </div>
          <div className="mt-2 text-xs text-emerald-400/90 font-sans">
        ...
        <div className="p-4 rounded-xl border border-white/5 bg-slate-950/30">
          ...
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-xs text-slate-500 font-sans">يوم في المتوسط</span>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="p-5 rounded-xl border border-white/5 bg-slate-950/20 flex flex-col justify-between">
          ...
          <div className="mt-6 border-t border-white/5 pt-4 text-xs text-slate-400 flex items-center gap-1 font-sans">
