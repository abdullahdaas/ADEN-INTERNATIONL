...
export default function HeroSearch({ onSearch, initialFilters = {} }: HeroSearchProps) {
  ...
  return (
    <div id="search-container" className="w-full rounded-2xl border border-white/5 bg-slate-900/40 backdrop-blur-md p-6 shadow-2xl shadow-black/50">
      ...
      {/* Search Type Tabs */}
      <div className="flex space-x-3 space-x-reverse border-b border-white/10 pb-4 mb-5">
        <button
          id="tab-search-sale"
          type="button"
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/5 bg-slate-950 px-4 py-3 pr-11 text-sm text-white placeholder-slate-500 transition-all focus:border-gold-prestige/40 focus:ring-1 focus:ring-gold-prestige/30 outline-none"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-white/5 bg-slate-950 px-4 py-3 text-sm text-white transition-all focus:border-gold-prestige/40 outline-none cursor-pointer appearance-none"
          ...
          <div>
            ...
            <select
              ...
              className="w-full rounded-xl border border-white/5 bg-slate-950 px-4 py-3 text-sm text-white transition-all focus:border-gold-prestige/40 outline-none cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed appearance-none"
              style={{ backgroundImage: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%2364748b' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><polyline points='6 9 12 15 18 9'/></svg>")`, backgroundPosition: 'left 12px center', backgroundRepeat: 'no-repeat', backgroundSize: '16px' }}
            >
          ...
          <div className="flex items-end gap-2 md:col-span-4 lg:col-span-1">
            <button
              ...
              type="submit"
              className="flex-1 flex items-center justify-center space-x-2 space-x-reverse rounded-xl bg-gold-prestige px-4 py-3 text-sm font-bold text-white transition-all hover:bg-gold-accent hover:shadow-lg hover:shadow-gold-prestige/20 cursor-pointer"
            >
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 border-t border-white/5 pt-4 animate-fade-in">
            ...
            <div>
              ...
              <select
                ...
                disabled={!district}
                className="w-full rounded-xl border border-white/5 bg-slate-950 px-4 py-3 text-sm text-white transition-all focus:border-gold-prestige/40 outline-none disabled:opacity-40 appearance-none"
                style={{ backgroundImage: `url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24' fill='none' stroke='%2364748b' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><polyline points='6 9 12 15 18 9'/></svg>")`, backgroundPosition: 'left 12px center', backgroundRepeat: 'no-repeat', backgroundSize: '16px' }}
              >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-white/5">
          ...
          <button
            ...
            className="flex items-center space-x-2 space-x-reverse text-sm font-semibold text-gold-prestige hover:text-gold-accent transition-all"
          >
            ...
            <div>
              ...
              <div className="space-y-2">
                <select
                  ...
                  className="w-full rounded-lg border border-white/5 bg-slate-950 px-3 py-2 text-xs text-white outline-none cursor-pointer"
                >
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-white/5 bg-slate-950 px-2 py-2 text-xs text-white outline-none"
                >
