              ...
              <div className="p-6 flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
                ...
                <div className="flex flex-wrap justify-end gap-3 w-full md:w-auto">
                  <button
                    ...
                    className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#F27D26] hover:bg-[#d96a1a] text-white px-5 py-2.5 rounded-xl font-bold transition-all text-xs shadow-lg shadow-[#F27D26]/20"
                  >
